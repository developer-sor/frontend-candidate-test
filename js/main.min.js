...
function validateForm(){var e=!0,n=$("#ssid"),t=$("#nationality"),r=$("#propertyvalue"),i=$("#amount"),a=1e5,o=1e7,s=r.val().length>0?parseInt(r.val()):1e5,l=i.val().length>0?parseInt(i.val()):1e5;11!=n.val().length?(n.next().text("Feil i fødselsnummer"),e=!1):n.next().text(""),isForeign&&t.val().length<4?(t.next().text("Skriv inn fullstendig nasjonalitet"),e=!1):t.next().text(""),l>s?(i.parent().next().text("Du kan ikke låne mer enn boligens verdi"),e=!1):a>s||s>o||a>l||l>o?(i.parent().next().text("Ugyldig beløp"),e=!1):i.parent().next().text(""),e&&sendFormWithAjax()}function sendFormWithAjax(){alert("all is ok")}var isForeign=!1;$(function(){$("#statsborgerInput").hide(),$(".arrowWrapper").on("click",function(){$(this).parent().find(".textWrapper").toggleClass("adjustHeight"),$(this).find("span").hasClass("glyphicon-chevron-up")?$(this).find(".glyphicon-chevron-up").removeClass("glyphicon-chevron-up").addClass("glyphicon-chevron-down"):$(this).find(".glyphicon-chevron-down").removeClass("glyphicon-chevron-down").addClass("glyphicon-chevron-up")}),$("#is_foreign").on("click",function(){$(this).is(":checked")?($("#statsborgerInput").show(),isForeign=!0):($("#statsborgerInput").hide(),isForeign=!1)}),$("#amount").slider({formater:function(e){return"Current value: "+e}}),$("#propertyvalue").slider({formater:function(e){return"Current value: "+e}}),$("#skjema").submit(function(e){e.preventDefault(),validateForm()})});
